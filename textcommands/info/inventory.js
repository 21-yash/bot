            ...
            const generateEmbed = (page) => {
                ...
                currentItems.forEach(invItem => {
                    ...
                    if (itemData.type !== lastType) {
                        description += `\n**${itemData.type.charAt(0).toUpperCase() + itemData.type.slice(1).replace('_', ' ')}**\n`;
                ...
                return createCustomEmbed(
                    ...
                    description,
                    '#87CEEB', // A nice sky blue color
                    {
                        footer: { text: `Page ${page + 1} of ${totalPages} • Gold: ${player.gold} 💰` },
                        timestamp: false // No need for a timestamp here
                    }
                );
            };
