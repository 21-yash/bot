                ...
                if (i.isButton()) {
                    ...
                    if (i.customId === "craft_confirm") {
                        ...
                        if (matchedRecipe) {
                            ...
                            await player.save();
                            client.emit("itemCrafted", message.author.id); // For achievements
                            if (matchedRecipe.result.itemId === 'alchemical_incubator') {
                                client.emit("itemCraft", message.author.id, 'alchemical_incubator');
                            }
